...
acarsdec:	acarsdec.o acars.o msk.o rtl.o air.o output.o alsa.o soundfile.o raw.o label.o
	$(CC) acarsdec.o acars.o msk.o rtl.o air.o output.o alsa.o soundfile.o raw.o label.o -o $@ $(LDLIBS)
